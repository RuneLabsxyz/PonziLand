...
const profiles = {
  ...
  katana: {
    PUBLIC_DOJO_RPC_URL: 'https://play.ponzis.fun/x/katana/katana',
    PUBLIC_DOJO_TORII_URL: 'https://play.ponzis.fun/torii',
    PUBLIC_DOJO_CHAIN_ID: 'WP_KATANA',
    PUBLIC_AVNU_URL: 'https://sepolia.api.avnu.fi',
    PUBLIC_EKUBO_URL: 'https://sepolia-api.ekubo.org',
    PUBLIC_DOJO_BURNER_ADDRESS: "0x127fd5f1fe78a71f8bcd1fec63e3fe2f0486b6ecd5c86a0466c3a21fa5cfcec",
    PUBLIC_DOJO_BURNER_PRIVATE: "0xc5b2fcab997346f3ea1c00b002ecf6f382c5f9c9659a3894eb783c5320f912",
    BYPASS_TOKEN: '',
    LAYERSWAP_TOKEN: '',
    PUBLIC_SOCIALINK_URL: 'https://socialink-sepolia.ponzi.land',
    PUBLIC_PONZI_API_URL: 'https://api-sepolia.ponzi.land',
...
const manifestPath = profile == 'sepolia' ? `/etc/config/manifest_sepolia.json` : `../contracts/manifest_${profile}.json`;
const dataPath = profile == 'sepolia' ? `/etc/config/sepolia.json` : `${profile}.json`;
