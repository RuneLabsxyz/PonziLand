...
<div class="wallet-info-container">
    <div class="wallets-stack">
        {#if accountDataProvider.isConnected}
            <Card>
                <div class="account-details">
                    ...
                    <p>
                        {shortenHex(
                            padAddress(accountDataProvider?.address ?? ""),
                            4,
                        )}
                    </p>
                    <button
                    ...
                    >
                        <img src={logoutImg} alt="logout" class="logout-icon" />
                    </button>
                </div>
            </Card>
        {:else}
            <Button class="connect-button" onclick={handleConnectWallet}
                >CONNECT</Button
            >
        {/if}
        ...
        {#if enablePhantom}
            ...
            {:else}
                <Button
                    class="connect-button phantom-button"
