...
pub struct AppState {
    ...
    pub messages_repository: Arc<MessagesRepository>,
...
impl AppState {
    ...
    pub fn new(
        ...
        messages_repository: Arc<MessagesRepository>,
...
impl FromRef<AppState> for Arc<MessagesRepository> {
    fn from_ref(app_state: &AppState) -> Self {
        app_state.messages_repository.clone()
    }
}
